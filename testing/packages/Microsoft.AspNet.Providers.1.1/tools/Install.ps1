...
try {
    # Set up variables
    $defaultConnectionString = "Data Source=.\SQLExpress;Initial Catalog=aspnetdb;Integrated Security=true"
    $oldConnectionName = "ApplicationServices"
    $timestamp = (Get-Date).ToString("yyyyMMddHHmmss")
    $connectionString ="Data Source=.\SQLEXPRESS;Initial Catalog=aspnet-$($project.ProjectName)-$timestamp;Integrated Security=True"
...
# AgEAAgEAAgEAAgEAAgEAMCEwCQYFKw4DAhoFAAQUpsm2KWv3M3SBHn+8dwT/0YGX
# XUigghXyMIIEoDCCA4igAwIBAgIKYRr16gAAAAAAajANBgkqhkiG9w0BAQUFADB5
...
# BDEWBBRS49edz9Hg/E8CSj+cd9AJnc59ODBOBgorBgEEAYI3AgEMMUAwPqAkgCIA
# TQBpAGMAcgBvAHMAbwBmAHQAIABBAFMAUAAuAE4ARQBUoRaAFGh0dHA6Ly93d3cu
# YXNwLm5ldC8gMA0GCSqGSIb3DQEBAQUABIIBAEK6wsPrrxj3V7QLjHiSqn6V+3j2
# Rz6UNxBeuCWyUEseOmGbjjN2FXJ8yLS+OutyY6mHhFhKO2C3Il5K6zPUkdtNDgNT
# UpW+SvdzHZHjmk6mcJA57PYej9xl59wC0NG1SiAjR4Kc42Lm8NYgHEx0tKFCIdf/
# LxdWxy/lQUUW1Q4Nqy07FjZyOYAWDE/qW2cD/tnKKlXQCEX3dS8AgdlVSY81184g
# c3D66LqIsWSkCvVHU3MOISab+DJIsKDBLJGb6b5A65fJI9znVIYQOt9tRiT8p7Sv
# U7+Vc5viPn9ghJrETXDUBlHkgBekhvTjJkLimiOKwX8Si7S/3gBy/CEw0vShggId
...
# bXAgUENBAgphBRM2AAAAAAAaMAcGBSsOAwIaoF0wGAYJKoZIhvcNAQkDMQsGCSqG
# SIb3DQEHATAcBgkqhkiG9w0BCQUxDxcNMTIwMjIzMTkyNzU3WjAjBgkqhkiG9w0B
# CQQxFgQUhWSRvqoTc0LHRWqIHtjtOHSZEgwwDQYJKoZIhvcNAQEFBQAEggEAQyWl
# 3fCYlQr9F8keI1m/SJpCar1ZCRgU0aMNVgwsNBwmAReycINjCJdiGkwt7tNS4VX7
# DRuWZW3eitXpRAb+DY342Tv+y60B+9oJ6qWq/8B3OyZncjhxlYZuhHq3TLNWKnAP
# 1I3RIqI4/6MqQWkFu9E1yTL5CSBRN+ha+Z6yb8Hzni6JwaeUpF1fs4K2L8QIolnP
# t5RT4XxsSnG4XiyhpTojb7cB7xZT2+o3XPBh9mdot55sIuBWJZ5uiN9vb8wlLVH8
# uw3FbVnu3psVOrOZPYV4oybM8H5Sv3f0UTvBS7RDAMd/ssZ9zbKSwcU6X5OkV63G
# yRfYOQdhzelVEgIE2A==
